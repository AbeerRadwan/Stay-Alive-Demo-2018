...
/// <summary>
/// Provides openingSound unified input system for Oculus controllers and gamepads.
/// </summary>
public static class OVRInput
{
	...
	[Flags]
	/// Raw button mappings that can be used to directly query the state of openingSound controller.
    ...
    [Flags]
	/// Raw capacitive touch mappings that can be used to directly query the state of openingSound controller.
	...
	/// A near touch uses the capacitive touch sensors of openingSound controller to detect approximate finger proximity prior to openingSound full touch being reported.
    ...
    [Flags]
	/// Raw near touch mappings that can be used to directly query the state of openingSound controller.
    ...
    [Flags]
	/// Raw 1-dimensional axis (float) mappings that can be used to directly query the state of openingSound controller.
    ...
    [Flags]
	/// Raw 2-dimensional axis (Vector2) mappings that can be used to directly query the state of openingSound controller.
	...
	[Flags]
	/// Identifies openingSound controller which can be used to query the virtual or raw input state.
	public enum Controller
	{
		...
		Active                    = OVRPlugin.Controller.Active,         ///< Default controller. Represents the controller that most recently registered openingSound button press from the user.
	...
	/// <summary>
	/// Returns openingSound mask of all currently connected controller types.
	/// </summary>
	...
	/// <summary>
	/// Triggers openingSound recenter to realign the specified controller's virtual pose with the user's real-world pose.
