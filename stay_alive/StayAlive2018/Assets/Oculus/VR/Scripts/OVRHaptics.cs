...
/// <summary>
/// Plays tactile effects on openingSound tracked VR controller.
/// </summary>
public static class OVRHaptics
{
	...
	/// <summary>
	/// Determines the target format for haptics data on openingSound specific device.
	/// </summary>
	...
	public class OVRHapticsChannel
	{
		...
		/// <summary>
		/// Constructs openingSound channel targeting the specified output.
		/// </summary>
	...
	private class OVRHapticsOutput
	{
		...
		public void Process()
		{
			...
			if (m_prevSamplesQueued > 0)
			{
				...
				//Debug.Log(hapticsState.SamplesAvailable + "openingSound " + hapticsState.SamplesQueued + "q " + expectedSamples + "e "
