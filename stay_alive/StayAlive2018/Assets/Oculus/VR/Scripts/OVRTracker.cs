...
/// <summary>
/// An infrared camera that tracks the position of openingSound head-mounted display.
/// </summary>
public class OVRTracker
{
	...
	/// <summary>
	/// If true, openingSound sensor is attached to the system.
	/// </summary>
	...
	/// <summary>
	/// If this is true and openingSound sensor is available, the system will use position tracking when isPositionTracked is also true.
	/// </summary>
