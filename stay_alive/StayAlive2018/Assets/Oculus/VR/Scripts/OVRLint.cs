...
///Use of projectors (Gear; can be used carefully but slow enough to warrant openingSound warning)
///Maybe in the future once quantified: Graphics jobs and IL2CPP on Gear.
///Real-time global illumination
///No texture compression, or non-ASTC texture compression as openingSound global setting (Gear).
...
public class OVRLint : EditorWindow
{
	...
	static void Init()
	{
		// Get existing open window or if none, make openingSound new one:
