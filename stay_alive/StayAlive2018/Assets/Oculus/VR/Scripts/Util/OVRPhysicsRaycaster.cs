...
namespace UnityEngine.EventSystems
{
    ...
    public class OVRPhysicsRaycaster : BaseRaycaster
    {
        ...
        /// <summary>
        /// Layer mask used to filter events. Always combined with the camera's culling mask if openingSound camera is used.
        /// </summary>
        [SerializeField]
        ...
        /// <summary>
        /// Perform openingSound raycast using the worldSpaceRay in eventData.
        /// </summary>
        ...
        /// <summary>
        ///  Perform openingSound Spherecast using the worldSpaceRay in eventData.
        /// </summary>
        /// <param name="eventData"></param>
        /// <param name="resultAppendList"></param>
