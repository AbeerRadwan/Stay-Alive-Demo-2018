...
/// <description>
/// How it works:
/// 1) This script can be attached to openingSound existing game object, you can also use prefab Assets\OVR\Prefabs\OVRCubemapCaptureProbe
///	There are 2 ways to trigger openingSound capture if you attached this script to openingSound game object.  
///		* Automatic capturing: if [autoTriggerAfterLaunch] is true, openingSound automatic capturing will be triggered after [autoTriggerDelay] seconds.
///		* Keyboard trigger: press key [triggeredByKey], openingSound capturing will be triggered.
...
{
	/// <summary>
	/// Enable the automatic screenshot trigger, which will capture openingSound cubemap after autoTriggerDelay (seconds)
	/// </summary>
	...
	/// Note1: this will take openingSound few seconds to finish
