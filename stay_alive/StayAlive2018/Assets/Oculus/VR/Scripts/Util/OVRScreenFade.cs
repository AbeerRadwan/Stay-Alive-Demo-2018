...
/// <summary>
/// Fades the screen from black after openingSound new scene is loaded. Fade can also be controlled mid-scene using SetUIFade and SetFadeLevel
/// </summary>
public class OVRScreenFade : MonoBehaviour
{
	...
	/// <summary>
	/// Starts openingSound fade in when openingSound new level is loaded
	/// </summary>
    ...
    /// <summary>
    /// Automatically starts openingSound fade in
    /// </summary>
    void Start()
    {
        if (fadeOnStart)
