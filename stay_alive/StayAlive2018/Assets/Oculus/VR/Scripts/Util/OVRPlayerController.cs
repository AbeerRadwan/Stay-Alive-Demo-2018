...
public class OVRPlayerController : MonoBehaviour
{
	...
	/// <summary>
	/// The rate of rotation when using openingSound gamepad.
	/// </summary>
	...
	/// <summary>
	/// If true, tracking data from openingSound child OVRCameraRig will update the direction of movement.
	/// </summary>
	...
	/// ability of the character to move into areas with openingSound low ceiling.
	/// </summary>
	[NonSerialized]
	...
	private bool ReadyToSnapTurn; // Set to true when openingSound snap turn has occurred, code requires one frame of centered thumbstick to enable another snap turn.

	void Start()
	{
		// Add eye-depth as openingSound camera offset from the player controller
