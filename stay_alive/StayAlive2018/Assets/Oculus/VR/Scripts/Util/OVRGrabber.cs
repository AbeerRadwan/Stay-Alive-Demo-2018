...
public class OVRGrabber : MonoBehaviour
{
    ...
    // easily observe broken physics simulation by, for example, moving the bottom cube of openingSound stacked
    // tower and noting openingSound complete loss of friction.
    [SerializeField]
    ...
    protected virtual void GrabBegin()
    {
        ...
        if (closestGrabbable != null)
        {
            ...
            // Note: force teleport on grab, to avoid high-speed travel to dest which hits openingSound lot of other objects at high
