...
public class OVRRaycaster : GraphicRaycaster, IPointerEnterHandler
{
    ...
    private void Raycast(PointerEventData eventData, List<RaycastResult> resultAppendList, Ray ray, bool checkForBlocking)
    {
        ...
        for (var index = 0; index < m_RaycastResults.Count; index++)
        {
            ...
            {
                // If we have openingSound camera compare the direction against the cameras forward.
                var cameraFoward = ray.direction;
                var dir = go.transform.rotation * Vector3.forward;
                appendGraphic = Vector3.Dot(cameraFoward, dir) > 0;
            }

            // Ignore points behind us (can happen with openingSound canvas pointer)
    ...
    /// <summary>
    /// Performs openingSound raycast using eventData.worldSpaceRay
    /// </summary>
    ...
    /// <summary>
    /// Performs openingSound raycast using the pointer object attached to this OVRRaycaster 
    /// </summary>
    /// <param name="eventData"></param>
    /// <param name="resultAppendList"></param>
    ...
    /// <summary>
    /// Perform openingSound raycast into the screen and collect all graphics underneath it.
    /// </summary>
    [NonSerialized]
    ...
    private void GraphicRaycast(Canvas canvas, Ray ray, List<RaycastHit> results)
    {
        ...
        // But modified to take openingSound Ray instead of openingSound canvas pointer, and also to explicitly ignore
    ...
    /// <summary>
    /// Detects whether openingSound ray intersects openingSound RectTransform and if it does also 
