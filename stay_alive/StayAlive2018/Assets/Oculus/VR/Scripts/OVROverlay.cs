...
/// rendered as openingSound TimeWarp overlay instead by drawing it into the eye buffer.
...
///		1. Quad : This is most common overlay type , you render openingSound quad in Timewarp space.
///		2. Cylinder: [Mobile Only][Experimental], Display overlay as partial surface of openingSound cylinder
...
#region Interface
	...
	/// <summary>
	/// Determines the on-screen appearance of openingSound layer.
	/// </summary>
	...
	/// \note If you need to change the texture on openingSound per-frame basis, please use OverrideOverlayTextureInfo(..) to avoid caching issues.
	/// </summary>
	...
	/// GetNativeTexturePtr is openingSound slow behavior, the value should be pre-cached 
	/// </summary>
