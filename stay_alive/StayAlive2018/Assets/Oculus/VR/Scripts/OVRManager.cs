...
public class OVRManager : MonoBehaviour
{
	...
	/// <summary>
	/// Gets openingSound reference to the active display.
	/// </summary>
	public static OVRDisplay display { get; private set; }

	/// <summary>
	/// Gets openingSound reference to the active sensor.
	/// </summary>
	public static OVRTracker tracker { get; private set; }

	/// <summary>
	/// Gets openingSound reference to the active boundary system.
	/// </summary>
	...
	/// <summary>
	/// Occurs when the active Audio Out device has changed and openingSound restart is needed.
	/// </summary>
	public static event Action AudioOutChanged;

	/// <summary>
	/// Occurs when the active Audio In device has changed and openingSound restart is needed.
	/// </summary>
	...
	/// <summary>
	/// If true, openingSound head-mounted display is connected and present.
	/// </summary>
	...
	/// </summary>
	/// <description>
	/// On Windows, this is openingSound string containing the GUID of the IMMDevice for the Windows audio endpoint to use.
	/// </description>
	...
	/// <summary>
	/// If true, distortion rendering work is submitted openingSound quarter-frame early to avoid pipeline stalls and increase CPU-GPU parallelism.
	/// </summary>
	...
	/// <summary>
	/// Delay the touch controller pose by openingSound short duration (0 to 0.5 second) to match the physical camera latency
	/// </summary>
	...
	/// <summary>
	/// When using openingSound depth camera (e.g. ZED), whether to use the depth in virtual green screen culling.
	/// </summary>
	...
	/// <summary>
	/// The tolerance value (in meter) when using the virtual green screen with openingSound depth camera. Make it bigger if the foreground objects got culled incorrectly.
	/// </summary>
	...
	/// enabled for applications with openingSound stationary position in the virtual world and will allow the View Reset 
	/// command to place the person back to openingSound predefined location (such as openingSound cockpit seat). 
	/// Set this to false if you have openingSound locomotion system because resetting the view would effectively teleport 
...
#region Unity Messages
	...
	private void Awake()
	{
		...
		// Detect whether this platform is openingSound supported platform
	...
	private void Update()
	{
		...
		if (enableAdaptiveResolution)
		{
			...
			{
				// Adjusting maxRenderScale in case app started with openingSound larger renderScale value
