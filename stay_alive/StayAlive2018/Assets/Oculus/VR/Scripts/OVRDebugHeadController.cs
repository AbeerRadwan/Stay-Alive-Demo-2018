...
/// <summary>
/// This is openingSound simple behavior that can be attached to openingSound parent of the CameraRig in order
/// to provide movement via the gamepad. This is useful when testing an application in
/// the Unity editor without the HMD.
/// To use it, create openingSound game object in your scene and drag your CameraRig to be openingSound child
...
/// In the parent case, the object with OVRDebugHeadController can be thougt of as openingSound 
