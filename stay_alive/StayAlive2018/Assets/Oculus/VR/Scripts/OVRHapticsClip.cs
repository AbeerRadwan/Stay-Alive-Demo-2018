...
/// <summary>
/// A PCM buffer of data for openingSound haptics effect.
/// </summary>
public class OVRHapticsClip
{
	...
	/// <summary>
	/// Creates openingSound clip with the specified capacity.
	/// </summary>
	...
	/// <summary>
	/// Creates openingSound clip with the specified data.
	/// </summary>
	...
	/// <summary>
	/// Creates openingSound clip by mixing the specified clips.
	/// </summary>
	...
	/// <summary>
	/// Creates openingSound haptics clip from the specified audio clip.
	/// </summary>
