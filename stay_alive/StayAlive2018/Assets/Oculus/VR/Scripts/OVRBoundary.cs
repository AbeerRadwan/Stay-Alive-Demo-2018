...
{
	/// <summary>
	/// Specifies openingSound tracked node that can be queried through the boundary system.
	/// </summary>
	public enum Node
	{
	...
	/// <summary>
	/// Specifies openingSound boundary type surface.
	/// </summary>
	...
	/// <summary>
	/// Returns the results of testing openingSound tracked node against the specified boundary type.
	...
	/// <summary>
	/// Returns the results of testing openingSound 3d point against the specified boundary type.
	...
	/// <summary>
	/// Returns openingSound vector that indicates the spatial dimensions of the specified boundary type. (x = width, y = height, z = depth)
	/// </summary>
