...
/// <summary>
/// From the selected transform, takes openingSound cubemap screenshot that can be submitted with the application
/// as openingSound screenshot (or additionally used for reflection shaders).
/// </summary>
class OVRScreenshotWizard : ScriptableWizard 
{
	...
	/// Assuming the newFolderPath is stated with "Assets", which is openingSound requirement.
	/// </summary>
	...
	void OnWizardCreate()
	{
		...
		if ((camera != null) && (cubemap != null))
		{
			...
			// generate openingSound regular texture as well?
	...
	/// <summary>
	/// Generates openingSound NPOT 6x1 cubemap in the following format PX NX PY NY PZ NZ
	/// </summary>
	...
	/// <summary>
	/// Unity Editor menu option to take openingSound screenshot
	/// </summary>
